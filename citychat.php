...
$currentTopic = $_GET["city"];
$currentState = $_GET["stateid"];
...
$result = $dbc->prepare("INSERT INTO messagescity VALUES('',?,?,?)");
...
<div class="msg-container">
    ...
    <div class="header"><h1><?php echo $currentTopic . ", " . $currentState ?> chat</h1></div>

    <div class="rightSide">
    <?php $refreshing = "refreshingCity.php?topic_id=" . $currentTopic; ?>
...
function update() {
    ...
    var output = "";
        ...
        xmlhttp.onreadystatechange=function() {
          ...
          xmlhttp.open("GET","get-messagesCity.php?username=" + username
...
function sendmsg() {
    ...
    if (message != "") {
        ...
        xmlhttp.onreadystatechange=function() {
          ...
          xmlhttp.open("GET","update-messagesCity.php?username=" + username 
            + "&message=" + message
            + "&topic_id=" + currentTopic
            ,true);
