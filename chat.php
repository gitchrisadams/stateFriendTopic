...
<?php
    ...
    echo '<br>Must be <a href="http://statefriendtopic.christopheradams.com/login.php">logged in</a> to chat.<br>';
    echo 'or<br>';
    echo '<a href="http://statefriendtopic.christopheradams.com/signup.php">Sign up</a> if not registered.<br>';
